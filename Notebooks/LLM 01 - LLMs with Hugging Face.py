...
# MAGIC
# MAGIC Whirlwind tour of some top applications using Large Language Models (LLMs):
# MAGIC * Summarization
...
# MAGIC
# MAGIC We will use a model which does *abstractive* summarization.
# MAGIC
# MAGIC
...
# MAGIC * **Model**: [t5-small](https://huggingface.co/t5-small) model, which has 60 million parameters (242MB for PyTorch).  T5 is an encoder-decoder model created by Google which supports several tasks such as summarization, translation, Q&A, and text classification. 
