...
full_dataset = load_dataset(
    "cnn_dailymail", version="3.0.0", cache_dir='/dbfs/mnt/dbacademy-datasets/large-language-models/v01/cnn_dailymail/default/3.0.0/1b3c71476f6d152c31c1730e83ccb08bcf23e348233f4fcc11e182248e6bf7de'
...
def summarize_with_t5(
    ...
    model = T5ForConditionalGeneration.from_pretrained(
        model_checkpoint, cache_dir='/dbfs/mnt/dbacademy-datasets/temp'
    ).to(device)
    tokenizer = AutoTokenizer.from_pretrained(
        model_checkpoint, model_max_length=1024, cache_dir='/dbfs/mnt/dbacademy-datasets/temp'
    )
